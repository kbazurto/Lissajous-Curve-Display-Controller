...
architecture behavioural of ssegDriver is
	...
	begin
		...
		process (clk, rst) 
			...
			with anode_reg select
			kevin <= negative when "10111111",
			         negative2 when "11101111",
			             '1' when others;
			
			with digitout_reg select
			cathode_p <= kevin & "1000000"when "0000", 	-- 0 
							kevin & "1111001" when "0001",	-- 1
							kevin & "0100100" when "0010",		-- 2
							kevin & "0110000" when "0011",		-- 3
							kevin & "0011001" when "0100",		-- 4
							kevin & "0010010" when "0101",		-- 5
							kevin & "0000010" when "0110",		-- 6
							kevin & "1111000" when "0111",		-- 7
							kevin & "0000000" when "1000",		-- 8
							kevin & "0011000" when "1001",		-- 9
							kevin & "0001000" when "1010",		-- A
							kevin & "0000011" when "1011",		-- B
							kevin & "1000110" when "1100",		-- C
							kevin & "0100001" when "1101",		-- D
							kevin & "0000110" when "1110",		-- E
							kevin & "0001110" when "1111";		-- F
